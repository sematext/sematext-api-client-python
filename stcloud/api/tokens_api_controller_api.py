...
class TokensApiControllerApi(object):
    ...
    def create_app_token(self, app_id, dto, **kwargs):  # noqa: E501
        ...
        :param CreateTokenDto dto: dto (required)
    ...
    def update_app_token(self, app_id, token_id, dto, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_app_token(app_id, token_id, dto, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int app_id: appId (required)
        :param int token_id: tokenId (required)
        :param UpdateTokenDto dto: dto (required)
        :return: GenericApiResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_app_token_with_http_info(app_id, token_id, dto, **kwargs)  # noqa: E501
        else:
            (data) = self.update_app_token_with_http_info(app_id, token_id, dto, **kwargs)  # noqa: E501
            return data
    ...
    def update_app_token_with_http_info(self, app_id, token_id, dto, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_app_token_with_http_info(app_id, token_id, dto, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['app_id', 'token_id', 'dto']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('dto' not in params or
                params['dto'] is None):
            raise ValueError("Missing the required parameter `dto` when calling `update_app_token`")  # noqa: E501
