...
class AlertsApi(object):
    ...
    def create_alert_using_post(self, dto, **kwargs):  # noqa: E501
        """Create alert rule  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_alert_using_post(dto, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AlertRule dto: dto (required)
        ...
        if kwargs.get('async_req'):
            return self.create_alert_using_post_with_http_info(dto, **kwargs)  # noqa: E501
        else:
            (data) = self.create_alert_using_post_with_http_info(dto, **kwargs)  # noqa: E501
            return data

    def create_alert_using_post_with_http_info(self, dto, **kwargs):  # noqa: E501
        """Create alert rule  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_alert_using_post_with_http_info(dto, async_req=True)
        >>> result = thread.get()
        ...
        if ('dto' not in params
            ...
            raise ValueError("Missing the required parameter `dto` when calling `create_alert_using_post`")  # noqa: E501
    ...
    def delete_alert_rule_using_delete_with_http_info(self, updateable_alert_id, **kwargs):  # noqa: E501
        ...
        if ('updateable_alert_id' not in params
                or params['updateable_alert_id'] is None):
