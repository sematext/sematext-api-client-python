...
class TestSubscriptionsApi(unittest.TestCase):
    ...
    def test_create_for_app_using_post(self):
        """Test case for create_for_app_using_post
    ...
    def test_update_for_app_using_put(self):
        """Test case for update_for_app_using_put
